<template>
    ...
    <div class="mb-3">
        ...
        <input id="sevenio-sender" v-model="$parent.notification.sevenioSender" type="text" class="form-control" autocomplete="false" placeholder="Uptime Monitoring System">
    </div>
